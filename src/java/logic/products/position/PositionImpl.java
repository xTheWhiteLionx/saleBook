...
public abstract class PositionImpl {
     ...
     * the {@link #PositionImpl(int, String, LocalDate, BigDecimal, State, BigDecimal, LocalDate,
     ...
     */
    public PositionImpl(int id, @NotNull String category, @NotNull LocalDate orderDate,
     ...
     * the {@link #PositionImpl(int, String, LocalDate, BigDecimal, BigDecimal)}
     * constructor instant.
     *
     * @param id               the id of this positionImpl
     * @param category            the model of this positionImpl
     ...
     */
    public @NotNull String getTrackingNumber() {
